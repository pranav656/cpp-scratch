...
TODO: Seems like a bug in one of the multiplications, check later
*/
...
int main() {
   ...
   //double phase = 0.0;
    double sigK = 3.0;
   vector<complex<double>> signal(1000);
    signal.reserve(1000);
    for(int x = 0; x<N; x++)
    {
